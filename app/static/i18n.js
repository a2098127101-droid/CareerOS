(() => {
  ...
  const EN = {
    "切换主题": "Theme",
    "让每一步成长都有依据。": "Make every step of growth evidence-based.",
    "围绕学生证据、职业目标与参赛作品，连接 AI Coach、教师指导和持续迭代。": "Connect student evidence, career goals, artifacts, AI coaching, advisor guidance, and continuous iteration.",
    "证据可追溯": "Traceable evidence",
    "角色有边界": "Role boundaries",
    "作品有版本": "Versioned artifacts",
    "登录": "Sign in",
    "注册账号": "Create account",
    "欢迎回来": "Welcome back",
    "登录后进入与你身份对应的工作空间。": "Sign in to enter the workspace assigned to your role.",
    "密码": "Password",
    "创建账号": "Create account",
    "选择身份并完成对应的安全注册流程。": "Select a role and complete its secure registration flow.",
    "注册身份": "Registration role",
    "学生": "Student",
    "教师": "Advisor",
    "学校管理员": "Organization administrator",
    "平台管理员": "Platform administrator",
    "学校或组织代码": "School or organization code",
    "教师及管理员账号需要有效邀请码。邀请码由学校管理员或平台管理员签发，系统会从邀请码中识别邮箱和组织。": "Advisor and administrator accounts require a valid invitation issued by an authorized administrator. The invitation determines the account email and organization.",
    "邀请码": "Invitation code",
    "设置密码": "Set password",
    "至少 10 个字符，建议同时包含大小写字母、数字和符号。": "Use at least 10 characters with uppercase and lowercase letters, numbers, and symbols.",
    "确认密码": "Confirm password",
    "创建学生账号": "Create student account",
    "平台管理员注册必须由现有平台管理员授权。CareerOS 不允许通过公开页面自行提升权限。": "Platform administrator registration requires authorization from an existing platform administrator. Public self-escalation is not allowed.",
    "CareerOS 简介": "CareerOS overview",
    "平台能力": "Platform capabilities",
    "账户操作": "Account actions",
    "由学校提供": "Provided by your school",
    "粘贴邀请链接中的代码": "Paste the code from your invitation link",
